...
public class CountingMinutes_M {

    public static int CountingMinutes_M(String str) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(CountingMinutes_M(s));

        String s1 = "1:23am-1:08am";
        System.out.println(CountingMinutes_M(s1));
    }
