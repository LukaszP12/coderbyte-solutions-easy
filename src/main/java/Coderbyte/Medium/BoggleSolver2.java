...
public class BoggleSolver2 {
    ...
    public static String BoggleSolver2(String[] strArr) {
            ...
            for (int j = 0; j < 4; j++) {
                if (boggleMatrix[i][j] == searchingChar) {
                    ...
                    for (int k = 1; k < word.length(); k++) {
                        ...
                        char nextSearching = word.charAt(k);
                        ArrayList<Node> dump = new ArrayList<>();

                        for (Node pNode : processor) {

                            if (boggleMatrix[pNode.getI()][pNode.getJ()] == nextSearching) {
                                Node t = pNode;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(BoggleSolver2(strings1));

        String[] strings = {"aaey, rrum, tgmn, ball", "all,ball,mur,raeymnl,rumk,tall,true,trum,yes"};
        System.out.println(BoggleSolver2(strings));
    }
